...
<head>
    ...
    <body>
      <table>
        ...
        <?php
          $conn = mysqli_connect("localhost", "root", "", "roba", "3306");
            ...
            $sql = "SELECT id, naziv_proizvoda, lokacija_proizvoda, cena_proizvoda FROM proizvodi";
      ...
      <form class="" action="tabelacena.php" method="post"><br>
        <button type="submit" class="btn2" name="submit">Sortiraj po Ceni (opadajuce)</button>
      </form>
    </body>
</html>
